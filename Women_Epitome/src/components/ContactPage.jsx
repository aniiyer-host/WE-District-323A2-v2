      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-24 px-4">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-6 leading-tight">
            <span className="bg-linear-to-r from-purple-600 via-pink-600 to-purple-600 bg-clip-text text-transparent playfair">Contact</span>
            <br />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <div className="mb-8">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-gray-800 mb-4 playfair">Let's Connect</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-linear-to-r from-purple-600 to-pink-600 text-white py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
                  {submitting ? (
                    <>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-purple-100">
                ...
                <p className="text-gray-600 mb-4">Stay connected with us on social media for updates, events, and inspiring stories.</p>
                <div className="flex flex-wrap gap-3">
                  {socialLinks.map((social, index) => {
                    const IconComponent = social.icon;
                    return (
                      <a key={index} href={social.url} className="flex items-center gap-2 bg-purple-50 hover:bg-purple-100 text-purple-700 px-4 py-2 rounded-full font-semibold transition-colors">
              ...
              <div className="bg-linear-to-br from-purple-600 to-pink-600 rounded-2xl p-8 text-white shadow-xl">
                ...
                <p className="mb-6 opacity-90">For urgent matters, please call us directly or send an email. We're here to help!</p>
                <div className="space-y-3">
                  ...
                  <a href="mailto:wedistrictclubsa21725@gmail.com" className="flex items-center gap-3 bg-white/20 backdrop-blur-sm p-4 rounded-xl hover:bg-white/30 transition-colors">
      ...
      <section className="py-24 px-4 bg-linear-to-b from-transparent to-purple-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="inline-block bg-purple-100 text-purple-700 px-6 py-2 rounded-full font-bold text-sm mb-4">FAQ</span>
            <h2 className="text-4xl md:text-5xl font-black text-gray-800 mb-4 playfair">Frequently Asked Questions</h2>
          </div>
          <div className="space-y-4">
            {[
              { question: "How can I join a WE Club?", answer: "You can contact us through the form above, call us directly, or visit one of our club meetings. We welcome all women who share our passion for service and empowerment." },
              { question: "What are the membership requirements?", answer: "Membership is open to all women who are committed to our mission of service and community empowerment. There are no specific educational or professional requirements." },
              { question: "How can I volunteer for projects?", answer: "You can volunteer by contacting your local club or reaching out to us through this contact form. We have various projects throughout the year that need volunteers." },
              { question: "Can I donate to support your projects?", answer: "Yes! We welcome donations to support our various community projects. Please contact us for more information on how to contribute." }
            ].map((faq, index) => (
