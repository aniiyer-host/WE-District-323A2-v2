...
const VileParle = () => {
    ...
    const galleryImages = [
        '/images/club-pages-imgs/VileParle/1.jpg',
        '/images/club-pages-imgs/VileParle/2.jpg',
        '/images/club-pages-imgs/VileParle/3.jpg',
        '/images/club-pages-imgs/VileParle/4.jpg',
    ];
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const res = await api.get('/clubs/vile-parle');
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border border-purple-100 hover:shadow-purple-200/50 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            <div className="bg-linear-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
                                <h3 className="text-2xl font-bold text-gray-800 mb-3">WE Club of Vile Parle Charitable Trust</h3>
                                <div className="space-y-2 text-gray-700">
                                    <p className="flex items-center gap-2">
                                        <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                        <span className="font-semibold">Year of inception:</span> 2018
                                    </p>
                                    <p className="flex items-center gap-2">
                                        <span className="w-2 h-2 bg-pink-500 rounded-full"></span>
                                        <span className="font-semibold">Registration:</span> E-0039035(GBR)
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border-l-4 border-purple-500 shadow-sm">
                                <p className="mb-4 leading-relaxed text-gray-700">
                                    <span className="font-semibold text-purple-900">Charter President:</span> WE Bhushan Narvekar<br />
                                    Founder and PDMP WE Saroja Mekal is Advisor and Extension Chairperson of WE Club of Vile Parle Charitable Trust.
                                </p>

                                <p className="mb-4 leading-relaxed text-gray-700">
                                    Right now we don't have 80 G or 12A. After receipt of PAN number we will apply for 80G.
                                </p>

                                <p className="mb-4 leading-relaxed text-gray-700">
                                    WE Club of Vile Parle charitable Trust was inaugurated on 21st September 2018 and continues to date. Our WE club of Vile Parle started with 23 members and now our membership strength is 37. For the last seven years we at WE Club of Vile Parle are proud to serve community that shares a deep passion for Women Epitome of service - a perfect example of a perfect woman.
                                </p>

                                <p className="mb-4 leading-relaxed text-gray-700">
                                    Our club started "Service Week" every month for 3 years. Together we make our club stronger and we look forward to many more successes ahead.
                                </p>

                                <div className="bg-linear-to-r from-purple-100 to-pink-100 rounded-xl p-4 mt-4">
                                    <p className="font-semibold text-purple-800 mb-2">🌟 Best Permanent Project:</p>
                                    <p className="text-gray-700 leading-relaxed">
                                        In March 2022 WE Club of Vile Parle Charitable Trust sponsored 'Home' at Hasengaon, Latur (Maharashtra) for HIV affected couple. This is our Best permanent project sponsored by all WE members.
                                    </p>
                                </div>
                                ...
                                <div className="mt-6 border-t pt-6">
                                    ...
                                    <div className="space-y-2 text-gray-700">
                                        <p>📧 Email: wevileparle@gmail.com</p>
