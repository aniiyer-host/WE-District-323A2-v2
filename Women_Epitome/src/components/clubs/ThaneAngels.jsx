...
const ThaneAngels = () => {
    ...
    const galleryImages = [
        '/images/club-pages-imgs/Angels/1.jpg',
        '/images/club-pages-imgs/Angels/2.jpg',
        '/images/club-pages-imgs/Angels/3.jpg',
        '/images/club-pages-imgs/Angels/4.jpg',
    ];
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const res = await api.get('/clubs/thane-angels');
            ...
            <section className="py-12 px-4 relative z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-purple-600">Latest initiatives from Thane Angels</p>
                    </div>
