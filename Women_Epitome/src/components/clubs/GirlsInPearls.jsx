...
const GirlsInPearls = () => {
    ...
    const galleryImages = [
        '/images/club-pages-imgs/GirlsinPearls/1.jpg',
        '/images/club-pages-imgs/GirlsinPearls/2.jpg',
        '/images/club-pages-imgs/GirlsinPearls/3.jpg',
    ];
    ...
    return (
      ...
      `}</style>
            ...
            <header className="bg-[#5EDFFF] text-[#3E64FF] text-center py-8 px-4">
                ...
                />
                <h1 className="text-3xl md:text-4xl font-bold mb-2">WE Club of Girls in Pearls</h1>
            ...
            <section className="py-8 px-4 my-8 max-w-4xl mx-auto">
                <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 mb-2">WE Club of Girls in Pearls</h3>
                    <h4 className="text-lg text-gray-700 mb-1">Year of Inception: 2023</h4>
                    <h4 className="text-lg text-gray-700 mb-1">Registration no.: Not yet Registered</h4>
                    <h4 className="text-lg text-gray-700 mb-6">Charter President: WE Prathibha Thakur</h4>

                    <div className="mb-6 italic">
                        <p className="mb-6 leading-relaxed">
                            Started in the year 2022-23 with 10 members and has since grown to 24 members. We have been doing big projects in the fields of Environment planted 400 flowering and fruit trees, Medical Health check up camp in schools, Support to senior citizen ashram, Education - promoting fine arts by conducting free kathak classes.
                        </p>
                    </div>
                </div>
            </section>
