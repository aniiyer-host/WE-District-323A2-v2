    ...
    return (
      ...
      `}</style>
            ...
            <header className="bg-[#5EDFFF] text-[#3E64FF] text-center py-8 px-4">
                ...
                />
                <h1 className="text-3xl md:text-4xl font-bold mb-2">WE Club of Dronagiri</h1>
            ...
            <section className="py-8 px-4 my-8 max-w-4xl mx-auto">
                <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 mb-2">WE Club of Dronagiri</h3>
                    ...
                    <div className="mb-6 italic">
                        <p className="font-semibold mb-4">
                            Charter President: WE Surekha Bhoir<br />
                            Club Extension Chairperson: WE Seema Gharat
                        </p>
