...
import { Home, Info, FolderOpen, Users, Mail, ArrowLeft, Sparkles, MapPin, Calendar, Star } from 'lucide-react';
...
const Belapur = () => {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const res = await api.get('/clubs/belapur');
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border border-purple-100 hover:shadow-purple-200/50 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            <div className="bg-linear-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
                                <h3 className="text-2xl font-bold text-gray-800 mb-3">WE Club of Belapur</h3>
                                <div className="space-y-2 text-gray-700">
                                    <p className="flex items-center gap-2">
                                        <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                        <span className="font-semibold">Year of inception:</span> 2022
                                    </p>
                                    <p className="flex items-center gap-2">
                            ...
                            <div className="bg-white rounded-2xl p-6 border-l-4 border-purple-500 shadow-sm">
                                <p className="font-semibold text-purple-900 mb-4">
                                    <span className="text-purple-600">Charter President:</span> WE Nutan Kumar<br />
                                    <span className="text-pink-600">Club Extension Chairperson:</span> Late WE Savitha Nayak
                                </p>
                                ...
                                <div className="bg-linear-to-r from-purple-100 to-pink-100 rounded-xl p-4 mt-4">
                                    <p className="font-semibold text-purple-800 mb-2">🌟 Best Project:</p>
            ...
            <section className="py-12 px-4 relative z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-purple-600">Latest initiatives from Belapur</p>
                    </div>
