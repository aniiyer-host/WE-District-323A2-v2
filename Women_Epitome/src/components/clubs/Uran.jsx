...
const Uran = () => {
    ...
    const galleryImages = [
        ...
        '/images/club-pages-imgs/Uran/3jpg',
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const res = await api.get('/clubs/uran');
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border border-purple-100 hover:shadow-purple-200/50 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            <div className="bg-linear-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
                                <h3 className="text-2xl font-bold text-gray-800 mb-3">WE Club of Uran</h3>
                                <div className="space-y-2 text-gray-700">
                                    <p className="flex items-center gap-2">
                                        <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                        <span className="font-semibold">Registration:</span> E-1386 (Raigad District)
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border-l-4 border-purple-500 shadow-sm">
                                <p className="mb-4 leading-relaxed text-gray-700">
                                    <span className="font-semibold text-purple-900">Charter President:</span> WE Uttara Ruikar<br />
                                    <span className="font-semibold">Originally established as:</span> Lioness Club of Uran 2009-2010<br />
                                    <span className="font-semibold">Lioness Charter President:</span> Ls Sapna Gaikwad<br />
            ...
            <section className="py-12 px-4 relative z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-purple-600">Latest initiatives from Uran</p>
                    </div>
