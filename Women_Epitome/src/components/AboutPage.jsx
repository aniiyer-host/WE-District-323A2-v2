...
const AboutPage = () => {
  ...
  useEffect(() => {
    const keys = ['about_areas', 'about_emblem', 'about_founders', 'about_presidents', 'about_slogan', 'about_team'];
    Promise.allSettled(keys.map(k => api.get(`/content/${k}`))).then(results => {
      const loaded = {};
      results.forEach((r, i) => {
        if (r.status === 'fulfilled' && r.value.data.success) {
          loaded[keys[i]] = r.value.data.data.content.value;
        }
      });
      setCms(loaded);
    });
  ...
  const areaItems = cms.about_areas || [
  ...
  const emblemData = cms.about_emblem || {
  ...
  const pastPresidents = cms.about_presidents || [
    { image: "/images/founders/6.jpg", name: "WE Mala Shetty", role: "District President (2018–2019)", club: "WE Club of Vasant Vihar", bio: "Slogan: Power to Empower." },
    { image: "/images/founders/7.jpg", name: "WE Sujatha Rao", role: "District President (2019–2021)", club: "WE Club of Vashi, Navi Mumbai", bio: "Slogan: Fellowship to Service." },
    { image: "/images/founders/8.jpg", name: "WE Asha Gupta", role: "District President (2021–2022)", club: "WE Club of Chembur Galaxy", bio: "Slogan: हाथ बढ़ाओ थामो और बढ़ते चलो." },
    { image: "/images/founders/9.jpg", name: "WE Arti Bhatia", role: "District President (2022–2023)", club: "WE Club of Chembur", bio: "Slogan: Rise to Serve." },
    { image: "/images/founders/10.jpg", name: "WE Manju Jain", role: "District President (2023–2024)", club: "WE Club of New Panvel Steel Town", bio: "Slogan: चलो दुनिया बदलते हैं." },
    { image: "/images/founders/11.jpg", name: "WE Sudha Kamath", role: "District President (2024–2025)", club: "WE Club of Vashi, Navi Mumbai", bio: "Slogan: सेवा से समृद्धि." },
  ];

  const sloganQuotes = cms.about_slogan || [
    { bold: true, text: "WE — \"WOMEN - EPITOME OF SERVICE means Perfect Example of A Perfect Woman\"" },
    { text: "Epitome can be described as the complete embodiment of something or the best example — the best of the best, the pinnacle." },
    { bold: true, label: "WOMAN", text: "is the Best example of power and strength, playing various multifaceted roles." },
    { text: "There is no exercise better for the heart than reaching down and lifting people to brighten their lives." },
    { text: "We are in this together. Let's draw strength from each other." },
  ];
  ...
  const aboutCards = [
    {
      ...
      content: { type: 'list', items: areaItems }
    },
    {
      id: 'emblem',
      icon: Star,
      ...
      content: { type: 'emblem', image: emblemData.image, items: emblemData.items }
    },
    {
      id: 'founders',
      icon: Users,
      ...
      content: {
        type: 'people',
        sections: [
          { heading: "Founders", people: founders },
          { heading: "District Presidents", people: pastPresidents }
        ]
      }
    },
    {
      ...
      content: { type: 'slogan', quotes: sloganQuotes }
    },
  ];
